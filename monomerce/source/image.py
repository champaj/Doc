...
DEFAULT_FORMAT = '#define %(prefix)s%(identifier)s %(filename)s\n'
...
output +='// This file is automatically generated. Any changes will be overwritten the next time images.py is invoked.\n\n'
